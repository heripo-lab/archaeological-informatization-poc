...
본 저장소는 『헤리티지: 역사와 과학』 제58권 제3호(2025년 9월 30일) 게재 논문 「대형 언어 모델(LLM)을 활용한 고고학 정보화 연구 – 발굴조사보고서의 메타데이터 자동 추출 파이프라인 개념 검증」에서 구현한 개념 증명(Proof of Concept, PoC) 코드의 “스냅샷”입니다. 학술적·기술적 투명성을 위해 소스코드를 공개합니다. 다만 이 저장소는 연구 시점의 기록 보존 목적이며, 추가 개발이나 제3자의 기여(Contribution)는 받지 않습니다.
